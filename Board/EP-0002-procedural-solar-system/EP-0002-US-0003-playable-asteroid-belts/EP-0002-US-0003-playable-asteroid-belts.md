...
title: Наполненные астероидные пояса
stage: draft
dependencies: [EP-0002-US-0002-coherent-orbital-world]
...
[Документация эпика](../Documentation.md): Раздел «Геометрия и содержимое»; E2-AC-01, E2-AC-03–04, E2-AC-06. Общая концепция: разделы 7–8.
...
Как игрок, я хочу различать протяжённые астероидные пояса и отдельные объекты внутри них, чтобы пространство имело читаемое содержимое на разных масштабах. В поясах есть неоднородная плотность, разрывы и локальные скопления, а игровые постоянные астероиды движутся по орбитам. Я могу приблизить пояс и выбрать отдельный игровой объект. Повторение заданного seed сохраняет его наполнение.
...
Ресурсные поля вокруг экономических кластеров принадлежат EP-0003, дополнительные поля среды — EP-0004. Плотность и количество игровых астероидов задаются проверяемыми настройками; эта история не вводит новую добычу.
...
EP-0002-US-0002-coherent-orbital-world. US-0002 даёт движущуюся систему с поясами, в которой размещаются игровые астероиды.
...
- EP-0002-US-0002-coherent-orbital-world: EP-0002-US-0002-TK-0001-absolute-orbit-math, EP-0002-US-0002-TK-0002-authoritative-orbit-runtime, EP-0002-US-0002-TK-0003-orbital-client-prediction.
...
|---|---|---|---|---|
| [TK-0001](./EP-0002-US-0003-TK-0001-seeded-belt-asteroids/EP-0002-US-0003-TK-0001-seeded-belt-asteroids.md) | Детерминированные игровые астероиды в поясах | engine | Внешние gates ниже | AC-0001, AC-0002, AC-0003 |
| [TK-0002](./EP-0002-US-0003-TK-0002-belt-detail-rendering/EP-0002-US-0003-TK-0002-belt-detail-rendering.md) | Неоднородные пояса и выбор игровых астероидов | client | TK-0001 + внешние gates | AC-0001, AC-0002, AC-0003 |
...
| 2026-09-22T14:40:41Z | StoryBuilder | Создан EP-0002-US-0003-TK-0001-seeded-belt-asteroids | stage approved; 3 files; engine; AC 1/2/3 |
| 2026-09-22T14:40:41Z | StoryBuilder | Создан EP-0002-US-0003-TK-0002-belt-detail-rendering | stage approved; 4 files; client; AC 1/2/3 |
