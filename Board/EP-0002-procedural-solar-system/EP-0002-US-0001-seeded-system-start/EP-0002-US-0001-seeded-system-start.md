...
title: Новая игра в воспроизводимой Солнечной системе
stage: draft
dependencies: []
...
# Новая игра в воспроизводимой Солнечной системе

## Входное техническое задание

[Документация эпика](../Documentation.md): Разделы «Масштаб», «Геометрия и содержимое», «Новая игра и сценарии»; E2-AC-01–03. Общая концепция: R-01–05, R-13.
...
Как игрок, я хочу начать новую игру в процедурной Солнечной системе, чтобы каждое прохождение получало собственную географию. В сценарии Default я вижу неподвижное Солнце, планеты допустимых типов и границы 2–5 поясов, а моя фактическая стартовая позиция соответствует 50–75 календарным дням прямого полёта до Солнца на максимальной скорости стартового корабля. Одинаковые seed, настройки, сценарий и версия генерации воспроизводят тот же мир, а обычная новая игра получает новый seed. При невозможной конфигурации я получаю понятную ошибку без запуска частично созданной системы.
...
Это первый вертикальный результат для Default с базовым показом созданного мира. Орбитальное движение, игровые астероиды поясов и перенос остальных сценариев принимаются отдельно в US-0002–0004; здесь они не считаются готовыми. Диапазон 3–7 планет остаётся начальной настройкой.
...
|---|---|---|---|---|
| [TK-0001](./EP-0002-US-0001-TK-0001-system-map-contract/EP-0002-US-0001-TK-0001-system-map-contract.md) | Сериализуемая структура системы и точные орбитальные данные | contracts | Внешние gates ниже | AC-0001, AC-0002 |
| [TK-0002](./EP-0002-US-0001-TK-0002-generation-input-schema/EP-0002-US-0001-TK-0002-generation-input-schema.md) | Проверяемая конфигурация генерации и вход загрузчика | engine | TK-0001 + внешние gates | AC-0001, AC-0002, AC-0003 |
| [TK-0003](./EP-0002-US-0001-TK-0003-seeded-world-bootstrap/EP-0002-US-0001-TK-0003-seeded-world-bootstrap.md) | Атомарная генерация Default с масштабом 50–75 дней | engine | TK-0002 + внешние gates | AC-0001, AC-0002, AC-0003 |
| [TK-0004](./EP-0002-US-0001-TK-0004-default-system-content/EP-0002-US-0001-TK-0004-default-system-content.md) | Настройки новой системы для Default | content-data | TK-0003 + внешние gates | AC-0001, AC-0002, AC-0003 |
| [TK-0005](./EP-0002-US-0001-TK-0005-initial-system-view/EP-0002-US-0001-TK-0005-initial-system-view.md) | Первый обзор Солнца, планет и границ поясов | client | TK-0004 + внешние gates | AC-0001, AC-0002 |
...
| 2026-09-22T14:40:41Z | StoryBuilder | Создан EP-0002-US-0001-TK-0001-system-map-contract | stage approved; 4 files; contracts; AC 1/2 |
| 2026-09-22T14:40:41Z | StoryBuilder | Создан EP-0002-US-0001-TK-0002-generation-input-schema | stage approved; 5 files; engine; AC 1/2/3 |
| 2026-09-22T14:40:41Z | StoryBuilder | Создан EP-0002-US-0001-TK-0003-seeded-world-bootstrap | stage approved; 5 files; engine; AC 1/2/3 |
| 2026-09-22T14:40:41Z | StoryBuilder | Создан EP-0002-US-0001-TK-0004-default-system-content | stage approved; 3 files; content-data; AC 1/2/3 |
| 2026-09-22T14:40:41Z | StoryBuilder | Создан EP-0002-US-0001-TK-0005-initial-system-view | stage approved; 4 files; client; AC 1/2 |
