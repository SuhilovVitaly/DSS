...
/// <summary>
/// Layout and hit-test geometry for the Trade overlay panel. 1400×900 is the standard
/// panel size for gameplay-mechanic windows (Docs/FirstRelease/Screens/ScreenCatalog.md).
/// Structural twin of <see cref="Finance.FinanceLayout"/>/<see cref="Station.StationLayout"/>.
/// </summary>
