...
public static class XenonStyle
{
    ...
    public const float SubtitleFontSize = 13f;
    ...
    public static readonly SKColor Teal = new(39, 213, 166);
    ...
    public static readonly SKPaint StatusGlow = MakePaint(new SKColor(39, 213, 166, 46));
    public static readonly SKPaint StatusDot = MakePaint(Teal);
    ...
    public static readonly SKPaint SubtitleText = MakeText(SubtitleFontSize, Teal, TypefaceRegular);
    ...
    public static readonly SKPaint FooterRightText = MakeText(FooterFontSize, Teal, TypefaceRegular, SKTextAlign.Right);
