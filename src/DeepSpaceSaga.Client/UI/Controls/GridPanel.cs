...
public static class GridPanel
{
    ...
    // Trade screen's grid column can be shifted right by another 200px, widening the
    // ship-compartment illustration's reserved strip to 400px total
    // (TradeScreen.GridPanelOriginX/_compartmentImageRect).
