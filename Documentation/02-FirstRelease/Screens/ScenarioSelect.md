...
- Стартовый сценарий и стартовый корабль игрока (см. `Documentation/02-FirstRelease/Mechanics/TetrarchClass.md`).
...
- Для сценариев без полностью заданной сети `masterSeed` используется для детерминированной генерации экономического графа, ролей станций, начальных складов и событий.
