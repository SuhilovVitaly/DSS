...
Основание: `Documentation/00-Process/CLAUDE.md`, `Documentation/01-Requirements/EngineRequirements.md`, `Documentation/03-Design/TacticalMapSpecification.md`, текущий код `src/` и тесты `tests/`.
...
- Требования: секции 3, 39, 42 и `Documentation/03-Design/TacticalMapSpecification.md`.
