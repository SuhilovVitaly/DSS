...
Документ фиксирует технические задания для расхождений, найденных при сравнении текущего кода DSS с `Documentation/01-Requirements/EngineRequirements.md`.
