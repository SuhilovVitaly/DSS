...
`validate` проверяет каталог и изображения, `features` заново извлекает 40 деталей из существующих исходников. Полный список команд и описание набора — в `Docs/PortraitGenerator.md`. Исходники, обзоры и эталон исключены из поставки клиента.
